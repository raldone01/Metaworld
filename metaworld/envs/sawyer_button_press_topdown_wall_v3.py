...
class SawyerButtonPressTopdownWallEnvV3(SawyerXYZEnv):
    ENV_NAME: str = "button-press-topdown-wall-v3"
    ...
    def model_path(self) -> str:
        return full_V3_path_for("sawyer_xyz/sawyer_button_press_topdown_wall.xml")
